    ...
    <section id="departments" className="py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-slate-900 mb-6">Leading Engineering Departments</h2>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-16">
          {departments.map((dept, index) => (
            <Card key={index} className="overflow-hidden hover-card border-0 shadow-lg bg-white">
                ...
                <div className="md:w-3/5">
                  <CardHeader className="pb-4">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <CardTitle className="text-xl text-slate-900 leading-tight">{dept.name}</CardTitle>
                    </div>
                  ...
                  <CardContent className="pt-0">
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-3 gap-4 text-center">
                        <div>
                          <div className="text-lg font-semibold text-slate-900">{dept.faculty}</div>
                          <div className="text-sm text-slate-600">Faculty</div>
                        </div>
                        <div>
                          <div className="text-lg font-semibold text-slate-900">{dept.students}</div>
                      ...
                      <div className="bg-slate-50 p-3 rounded-lg">
                        <div className="text-sm text-slate-600">Head of Department</div>
                        <div className="font-semibold text-slate-900">{dept.head}</div>
                      </div>

                      {/* Specializations */}
                      <div>
                        <div className="text-sm font-semibold text-slate-900 mb-2">Key Areas:</div>
        ...
        <div className="bg-gradient-to-r from-slate-900 to-blue-900 text-white rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-300">Our departments consistently deliver outstanding results</p>
          </div>
