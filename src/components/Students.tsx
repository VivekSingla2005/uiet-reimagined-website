                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-blue-50 p-4 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600">Intake: 120 students | Class Coordinator: Dr. Rajesh Kumar</p>
                      </div>
                      <div className="bg-green-50 p-4 rounded-lg">
                        <h5 className="font-semibold mb-2">Electronics & Communication</h5>
                        <p className="text-sm text-gray-600">Intake: 60 students | Class Coordinator: Dr. Priya Sharma</p>
                      </div>
                      <div className="bg-purple-50 p-4 rounded-lg">
                        <h5 className="font-semibold mb-2">Mechanical Engineering</h5>
                        <p className="text-sm text-gray-600">Intake: 60 students | Class Coordinator: Prof. Amit Singh</p>
                      </div>
                      <div className="bg-orange-50 p-4 rounded-lg">
                        <h5 className="font-semibold mb-2">Information Technology</h5>
                        <p className="text-sm text-gray-600">Intake: 60 students | Class Coordinator: Dr. Neha Gupta</p>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="border-l-4 border-green-500 pl-4">
                        ...
                        <p className="text-sm text-gray-600">15th - 17th July 2024</p>
                      </div>
