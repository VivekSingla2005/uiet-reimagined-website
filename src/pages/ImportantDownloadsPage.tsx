...
const ImportantDownloadsPage = () => {
  ...
  const downloads = {
    ...
    placement: [
      { name: 'Placement Brochure 2024', type: 'PDF', size: '8.5 MB', date: '2024-01-25', category: 'Brochure' },
      ...
      { name: 'Placement Statistics 2023', type: 'PDF', size: '3.2 MB', date: '2024-01-18', category: 'Reports' },
